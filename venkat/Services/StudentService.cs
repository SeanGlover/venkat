...
namespace venkat.Services
{
    ...
    public class StudentService : IStudentService
    {
        ...
        public List<Student> Get() { return _students.Find(student => true).ToList(); }
        public Student Get(string id) { return _students.Find(student => student.Id == id).FirstOrDefault(); }
